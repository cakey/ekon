"""
Hybrid Champion - NEW MAX PROFIT FRONTIER POINT

=== EXPERIMENT FINDINGS ===

Iteration 33: Combined hybrid movement with depth2's buy/sell strategy.

Strategy:
1. Hybrid movement scoring: edge_score + 0.5 * global_opportunity_score
   - edge_score: immediate arbitrage profit (buy here, sell at neighbor)
   - global_score: cheap buying opportunities at neighbor
...
DOMINATES entire depth2 family (depth2_global, top4, all).
New max profit frontier point.
"""
