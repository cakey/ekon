...
agents = {
    ...
    # Balanced tier (0.01-0.1ms) - depth2_global variants form NEW FRONTIER
    "depth2_global": depth2_global.agent,     # $8,161/r @ 0.0245ms (DOMINATES entire balanced+max tier!)
    "depth2_global_top4": depth2_global_top4.agent,  # $8,398/r @ 0.0353ms (frontier: more neighbors = more profit)
    "depth2_global_all": depth2_global_all.agent,    # $9,017/r @ 0.0834ms (max profit frontier point)
